...
public class Object2 : Object
{
    ...
    {
        Object clone = Instantiate(original, position, rotation, parent);
    ...
    {
        Object clone = Instantiate(original, position, rotation);
        clone.name = original.name;
        return clone;
    }
    ...
    {
        T clone = Instantiate(original, parent, worldPositionStays);
        clone.name = original.name;
        return clone;
    }
    ...
    {
        T clone = Instantiate(original, position, rotation, parent);
        clone.name = original.name;
        return clone;
    }
    ...
    {
        T clone = Instantiate(original, position, rotation);
        clone.name = original.name;
        return clone;
    }
    ...
    {
        Object clone = Instantiate(original, parent, instantiateInWorldSpace);
        clone.name = original.name;
        return clone;
    }
    ...
    {
        Object clone = Instantiate(original, parent);
        clone.name = original.name;
        return clone;
    }
